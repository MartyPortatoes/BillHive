...
- Read-only **Checks**, **Trips**, and Shared Bills surfaces display iOS restaurant checks, travel expenses, balances, suggested settlements, and guest-side share references when those modes are synced
